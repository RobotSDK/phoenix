	...
	protected static Boolean covers(Constraint constraint1, Constraint constraint2)
	{
		...
		switch (relation1)
		{
			case EQU:
				...
				switch (relation2)
				{
					case EQU: return constraint1.getLongValue().equals(constraint2.getLongValue());
			...
			case LEQ: 
				...
				switch (relation2)
				{
					case EQU: return constraint1.getLongValue() >= constraint2.getLongValue();
					case LEQ: return constraint1.getLongValue() >= constraint2.getLongValue();
					case GEQ: return false;
					case NEQ: return false;
					case ANY: return false;
				}
			...
			case GEQ:
				...
				switch (relation2)
				{
					case EQU: return constraint1.getLongValue() <= constraint2.getLongValue();
					case LEQ: return false;
					case GEQ: return constraint1.getLongValue() <= constraint2.getLongValue();
					case NEQ: return false;
					case ANY: return false;
				}
			...
			case NEQ:
				...
				switch (relation2)
				{
					...
					case LEQ: return constraint1.getLongValue() > constraint2.getLongValue();
					case GEQ: return constraint1.getLongValue() < constraint2.getLongValue();
					case NEQ: return constraint1.getLongValue().equals(constraint2.getLongValue());
					case ANY: return false;
				}
